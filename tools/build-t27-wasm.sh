...
# and the external format readers and writers with the Ternary Check contract
# functions of t27/ternary_contract.t27, the real-layer product of
...
# tests/ternary_contract_wasm_replay.mjs, tests/matvec_wasm.mjs and
# tests/matrix_wasm.mjs.
set -eu
cd "$(dirname "$0")/.."
out=build/t27
clang=${WASM_CC:-clang}
