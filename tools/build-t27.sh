...
for module in codecs container compute sparsity json json_writer tensorpack tensorpack_json tensorpack_cli http bridge client random rtl_driver experiments reports python_api cli; do
