...
for module in codecs container compute sparsity json json_writer formats tensorpack tensorpack_json tensorpack_cli http bridge client random rtl_driver experiments reports python_api cli; do
