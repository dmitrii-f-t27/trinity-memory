...
for module in codecs compute tensorpack json formats live ternary_contract tensorpack_json tensorpack_cli http bridge client random matvec matrix rtl_driver; do
...
"${PYTHON:-python3}" -m unittest tests.test_ddr3_pattern tests.test_ddr3_uart_debug tests.test_ddr3_reader -v
