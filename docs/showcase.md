# Материал для демонстрации и GitHub
...
5. Показать план измерения FPGA. Числа по байтам уже подтверждены; частота,
   энергопотребление, физические BRAM и tokens/s требуют отдельного измерения.
...
## До будущей публикации

- Выбрать целевой GitHub repository и лицензию с владельцами проекта.
- Проверить состав коммита, опубликовать код и дождаться фактического результата CI.
