...
#   RUNTIME=release  the platform wheel of VERSION (default: pyproject.toml next to
#                    this directory, i.e. the Action's ref) from RELEASE_URL/vVERSION/,
#                    checked against that release's SHA256SUMS, unpacked, no pip
