...
полноценный inference engine остаётся следующим этапом. 2026-09-11 наборы потактовых трасс
stream compute (27 векторов, 288 тактов) воспроизведены на плате ALINX AX7203 (XC7A200T)
в двух вариантах тактирования: захваченный вывод устройства совпал с эталоном в каждом прогоне
([reports/fpga](reports/fpga/README.md)); DDR, энергопотребление и пропускная
способность вне этих нагрузок не измерены.
