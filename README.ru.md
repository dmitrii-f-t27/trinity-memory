...
stream compute (24 вектора, 243 такта) воспроизведены на плате ALINX AX7203 (XC7A200T):
захваченный вывод устройства совпал с эталоном в трёх одинаковых прогонах
