...
Число блоков BRAM, LUT и триггеров и оценки частоты nextpnr для трёх раскладок
36-битного слова измерены на AX7203 открытым маршрутом ([docs/hardware.md](docs/hardware.md),
