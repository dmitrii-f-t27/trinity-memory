// Actual payload memory width is 10 bits per five independent 2-bit trits.
`timescale 1ns/1ps
`default_nettype none
module ternary_baseline5_stream #(
    ...
    ternary_stream_storage #(
        .CODE_WIDTH(10), .WORDS(WORDS), .ADDR_WIDTH(ADDR_WIDTH)
    ) storage (
    ...
    ternary_baseline5_decoder decoder (.code(code), .trits(decoded), .valid(code_valid));
